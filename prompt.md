...
|---|---|---|
|Vector DB|ChromaDB|Open-source, simple deployment, strong Python SDK|
|Relational DB|PostgreSQL|Structured metadata, user data, session storage|
|Cache|Redis|Low-latency session memory and embedding cache|

File Storage: Local / S3 — Raw PDF storage before processing 
